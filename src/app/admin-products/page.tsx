...
function Page() {
    ...
    const handleCreateOrder = async () => {
        ...
        if (response.ok) {
            ...
            setOrderDetails({ productId: "", quantity: 0, customerName: "", customerAddress: "", customerPhone: "" }); // Reset form
        } else {
    ...
    const filteredProducts = products.filter((product) => {
        ...
        const matchesDate = searchDate ? new Date(product.createdAt).toLocaleDateString() === new Date(searchDate).toLocaleDateString() : true;
                    ...
                    <Form layout="vertical">
                        <Form.Item label="Số lượng">
                            <InputNumber
                                ...
                                onChange={(value) => setOrderDetails({ ...orderDetails, quantity: value || 0 })}
                            />
                        </Form.Item>
